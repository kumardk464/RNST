package com.ascendia.dheeraj.rnst.popupwindow;
...
/**
 * Created by mr on 14-8-5. An extended PopupWindow which could add a pointer to
 * the anchor view. You could set your own pointer image, this widget will
 * compute the pointer location for you automatically.
 */
public class PointerPopupWindow extends PopupWindow {
	...
	public PointerPopupWindow(Context context, int width, int padding_left, int padding_top, int padding_right, int padding_bottom) {
	...
	public void setBackgroundDrawable(Drawable background) {
		...
		param.setMargins(padding_left,padding_top,padding_right,padding_bottom);
